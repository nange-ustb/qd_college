...
//        $("#province_input").val( sProvince.find("option:selected").text() );
//        $("#city_input").val( sCity.find("option:selected").text() );
...
//    $("#city_input").val( sCity.find("option:selected").text() );
        sProvince.change(function() {
//    $("#province_input").val( sProvince.find("option:selected").val() );
            sCity.empty();
            loc.fillOption(sCity , '0,'+sProvince.val());
            sCounty.empty();
            loc.fillOption(sCounty , '0,' + sProvince.val() + ',' + sCity.val());
        ...
        sCity.change(function() {
//    $("#city_input").val( sCity.find("option:selected").val() );
            sCounty.empty();
            loc.fillOption(sCounty , '0,' + sProvince.val() + ',' + sCity.val());
        })
        sCounty.change(function(){
